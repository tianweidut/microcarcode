...
#define         PWM_CYCLE       49151   /* PWM cycle 16ms               */
                                        ...
                                        /*         = 16[ms] / 325.5[ns] */
                                        /*         = 49152              */
#define         SERVO_CENTER    4452   //3755   //enter value of Servo        */
...
/////////////////////////////////////////////////////////////////
 timerCnt++;	
	...
	if(crankFlag==0&&(int)eCurSpeed>290&&(int)eCurSpeed<330&&timerCnt<2) 
	{
   ...
   if(crankFlag==0&&(int)eCurSpeed<345&&(int)eCurSpeed>330&&timerCnt<15)
	{
		ITU4_BRA=(unsigned long)(PWM_CYCLE-1)>>6;//1/8
		ITU3_BRB=(unsigned long)(PWM_CYCLE-1)>>6;
	
		for(speedBrake_var=700;speedBrake_var!=0;speedBrake_var--);
	}
...
void rightAngle()
{
	...
	{
		crankFlag=1;	
		if(cnt1<30) speed(-60-6,-60-6);
		else if(cnt1<80) speed(-63-6,-63-6);
		else if(cnt1<120) speed(-66-6,-66-6);
		else if(cnt1< 180) speed(-70-6,-70-6);
